...
int whithThreecheck(char boad[MAX][MAX][MAX], int a, int b) {
	if ((strcmp(boad[a][b], boad[a + 1][b]) == 0 && strcmp(boad[a][b], boad[a + 2][b]) == 0) ||						// 세로 검사
	...
	else if ((strcmp(boad[a][b], boad[a + 3][b]) == 0 && (strcmp(boad[a][b], boad[a + 2][b]) == 0 || strcmp(boad[a][b], boad[a + 1][b]) == 0)) ||
		(strcmp(boad[a][b], boad[a - 3][b]) == 0 && (strcmp(boad[a][b], boad[a - 2][b]) == 0 || strcmp(boad[a][b], boad[a - 1][b]) == 0)))// 세로 검사 2
		return 1;

	else if ((strcmp(boad[a][b], boad[a - 1][b]) == 0 && (strcmp(boad[a][b], boad[a + 2][b]) == 0)) ||
		(strcmp(boad[a][b], boad[a + 1][b]) == 0 && (strcmp(boad[a][b], boad[a - 2][b]) == 0)))						// 세로 검사 3
		return 1;
	...
	else if ((strcmp(boad[a][b], boad[a - 3][b + 3]) == 0 && (strcmp(boad[a][b], boad[a - 2][b + 2]) == 0 || strcmp(boad[a][b], boad[a - 1][b + 1]) == 0)) ||
		(strcmp(boad[a][b], boad[a + 3][b - 3]) == 0 && (strcmp(boad[a][b], boad[a + 2][b - 2]) == 0 || strcmp(boad[a][b], boad[a + 1][b - 1]) == 0)))		// 대각선1 검사 2
		return 1;

	else if ((strcmp(boad[a][b], boad[a - 1][b + 1]) == 0 && (strcmp(boad[a][b], boad[a + 2][b - 2]) == 0)) ||
		(strcmp(boad[a][b], boad[a + 1][b - 1]) == 0 && (strcmp(boad[a][b], boad[a - 2][b + 2]) == 0)))						// 대각선1 검사 3
		return 1;
		...
		(strcmp(boad[a][b], boad[a + 3][b + 3]) == 0 && (strcmp(boad[a][b], boad[a + 2][b + 2]) == 0 || strcmp(boad[a][b], boad[a + 1][b + 1]) == 0)))		// 대각선2 검사 2
		return 1;

	else if ((strcmp(boad[a][b], boad[a + 1][b + 1]) == 0 && (strcmp(boad[a][b], boad[a - 2][b - 2]) == 0)) ||
		(strcmp(boad[a][b], boad[a - 1][b - 1]) == 0 && (strcmp(boad[a][b], boad[a + 2][b + 2]) == 0)))						// 대각선2 검사 3
		return 1;
}
// 33가로 검사
int HeightThreecheck(char boad[MAX][MAX][MAX], int a, int b) {
	...
	if ((strcmp(boad[a][b], boad[a][b + 3]) == 0 && (strcmp(boad[a][b], boad[a][b + 2]) == 0 || strcmp(boad[a][b], boad[a][b + 1]) == 0)) ||
		(strcmp(boad[a][b], boad[a][b - 3]) == 0 && (strcmp(boad[a][b], boad[a][b - 2]) == 0 || strcmp(boad[a][b], boad[a][b - 1]) == 0)))// 가로 검사 2
		return 1;

	if ((strcmp(boad[a][b], boad[a][b - 1]) == 0 && (strcmp(boad[a][b], boad[a][b + 2]) == 0)) ||
		(strcmp(boad[a][b], boad[a][b + 1]) == 0 && (strcmp(boad[a][b], boad[a][b - 2]) == 0)))						// 가로 검사 3
		return 1;

	if ((strcmp(boad[a][b], boad[a - 1][b + 1]) == 0 && strcmp(boad[a][b], boad[a - 2][b + 2]) == 0) ||		// 대각선 1 검사
		(strcmp(boad[a][b], boad[a - 1][b + 1]) == 0 && strcmp(boad[a][b], boad[a + 1][b - 1]) == 0) ||
		(strcmp(boad[a][b], boad[a + 1][b - 1]) == 0 && strcmp(boad[a][b], boad[a + 2][b - 2]) == 0))
		return 1;

	if ((strcmp(boad[a][b], boad[a - 3][b + 3]) == 0 && (strcmp(boad[a][b], boad[a - 2][b + 2]) == 0 || strcmp(boad[a][b], boad[a - 1][b + 1]) == 0)) ||
		(strcmp(boad[a][b], boad[a + 3][b - 3]) == 0 && (strcmp(boad[a][b], boad[a + 2][b - 2]) == 0 || strcmp(boad[a][b], boad[a + 1][b - 1]) == 0)))		// 대각선1 검사 2
		return 1;

	if ((strcmp(boad[a][b], boad[a - 1][b + 1]) == 0 && (strcmp(boad[a][b], boad[a + 2][b - 2]) == 0)) ||
		(strcmp(boad[a][b], boad[a + 1][b - 1]) == 0 && (strcmp(boad[a][b], boad[a - 2][b + 2]) == 0)))						// 대각선1 검사 3
		return 1;

	if ((strcmp(boad[a][b], boad[a - 1][b - 1]) == 0 && strcmp(boad[a][b], boad[a - 2][b - 2]) == 0) ||		// 대각선 2 검사
		(strcmp(boad[a][b], boad[a - 1][b - 1]) == 0 && strcmp(boad[a][b], boad[a + 1][b + 1]) == 0) ||
		(strcmp(boad[a][b], boad[a + 1][b + 1]) == 0 && strcmp(boad[a][b], boad[a + 2][b + 2]) == 0))
		return 1;
...
int diagonalThreecheck1(char boad[MAX][MAX][MAX], int a, int b) {
	...
	if ((strcmp(boad[a][b], boad[a + 3][b]) == 0 && (strcmp(boad[a][b], boad[a + 2][b]) == 0 || strcmp(boad[a][b], boad[a + 1][b]) == 0)) ||
		(strcmp(boad[a][b], boad[a - 3][b]) == 0 && (strcmp(boad[a][b], boad[a - 2][b]) == 0 || strcmp(boad[a][b], boad[a - 1][b]) == 0)))// 세로 검사 2
		return 1;
...
int whithCheckCase2(char boad[MAX][MAX][MAX], int a, int b) {
	int result = 0;
	if (((strcmp(boad[a][b], boad[a][b + 1]) == 0 && strcmp(boad[a][b], boad[a][b + 3]) == 0) && strcmp(boad[a][b], "○") == 0)) {	// 가로 case 1
		for (int i = 0; i < 4; i++)
		{
			if (i == 2)
				continue;
	...
	else if ((strcmp(boad[a][b], boad[a][b - 1]) == 0 && strcmp(boad[a][b], boad[a][b + 2]) == 0) && strcmp(boad[a][b], "○") == 0) {	// 가로 case 2
		for (int i = -1; i < 2; i++)
		{
			if (i == 1)
				continue;
	...
	else if ((strcmp(boad[a][b], boad[a][b - 2]) == 0 && strcmp(boad[a][b], boad[a][b - 3]) == 0) && strcmp(boad[a][b], "○") == 0) { // 가로 case 3
		for (int i = -3; i < 1; i++)
		{
			if (i == -1)
				continue;
	...
	else if ((strcmp(boad[a][b], boad[a][b + 2]) == 0 && strcmp(boad[a][b], boad[a][b + 3]) == 0) && strcmp(boad[a][b], "○") == 0) { // 가로 case 4
		for (int i = 0; i < 4; i++)
		{
			if (i == 1)
				continue;
	...
	else if ((strcmp(boad[a][b], boad[a][b + 1]) == 0 && strcmp(boad[a][b], boad[a][b - 2]) == 0) && strcmp(boad[a][b], "○") == 0) { // 가로 case 5
		for (int i = -2; i < 2; i++)
		{
			if (i == -1)
				continue;
	...
	else if ((strcmp(boad[a][b], boad[a][b - 1]) == 0 && strcmp(boad[a][b], boad[a][b - 3]) == 0) && strcmp(boad[a][b], "○") == 0) { // 가로 case 6
		for (int i = -3; i < 1; i++) {
			if (i == -2)
				continue;
			if (whithThreecheck(boad, a, b + i) == 1)
...
int HeightCheckCase2(char boad[MAX][MAX][MAX], int a, int b) {
	int result = 0;
	if (((strcmp(boad[a][b], boad[a + 1][b]) == 0 && strcmp(boad[a][b], boad[a + 3][b]) == 0) && strcmp(boad[a][b], "○") == 0)) {	//case 1
		for (int i = 0; i < 4; i++)
		{
			if (i == 2)
				continue;
	...
	else if ((strcmp(boad[a][b], boad[a - 1][b]) == 0 && strcmp(boad[a][b], boad[a + 2][b]) == 0) && strcmp(boad[a][b], "○") == 0) {	//case 2
		for (int i = -1; i < 3; i++)
		{
			if (i == 1)
				continue;
	...
	else if ((strcmp(boad[a][b], boad[a - 2][b]) == 0 && strcmp(boad[a][b], boad[a - 3][b]) == 0) && strcmp(boad[a][b], "○") == 0) { // case 3
		for (int i = -3; i < 1; i++)
		{
			if (i == -1)
				continue;
	...
	else if ((strcmp(boad[a][b], boad[a + 2][b]) == 0 && strcmp(boad[a][b], boad[a + 3][b]) == 0) && strcmp(boad[a][b], "○") == 0) { // case 4
		for (int i = 0; i < 4; i++)
		{
			if (i == 1)
				continue;
	...
	else if ((strcmp(boad[a][b], boad[a + 1][b]) == 0 && strcmp(boad[a][b], boad[a - 2][b]) == 0) && strcmp(boad[a][b], "○") == 0) { // case 5
		for (int i = -2; i < 2; i++)
		{
			if (i == -1)
				continue;
	...
	else if ((strcmp(boad[a][b], boad[a - 1][b]) == 0 && strcmp(boad[a][b], boad[a - 3][b]) == 0) && strcmp(boad[a][b], "○") == 0) { // case 6
		for (int i = -3; i < 1; i++) {
			if (i == -2)
				continue;
			if (HeightThreecheck(boad, a + i, b) == 1)
...
int diagonalCheckCase12(char boad[MAX][MAX][MAX], int a, int b) {
	int result = 0;
	if (((strcmp(boad[a][b], boad[a - 2][b + 2]) == 0 && strcmp(boad[a][b], boad[a - 3][b + 3]) == 0) && strcmp(boad[a][b], "○") == 0)) {	// case 1
		for (int i = 0; i < 4; i++){
			if (i == 1)
				continue;
	...
	else if ((strcmp(boad[a][b], boad[a + 2][b - 2]) == 0 && strcmp(boad[a][b], boad[a - 1][b + 1]) == 0) && strcmp(boad[a][b], "○") == 0) { // case 2
		for (int i = -2; i < 2; i++)
		{
			if (i == -1)
				continue;
	...
	else if ((strcmp(boad[a][b], boad[a + 3][b - 3]) == 0 && strcmp(boad[a][b], boad[a + 1][b - 1]) == 0) && strcmp(boad[a][b], "○") == 0) { // case 3
		for (int i = -3; i < 1; i++)
		{
			if (i == -2)
				continue;
	...
	else if ((strcmp(boad[a][b], boad[a - 1][b + 1]) == 0 && strcmp(boad[a][b], boad[a - 3][b + 3]) == 0) && strcmp(boad[a][b], "○") == 0) { // case 4
		for (int i = 0; i < 4; i++)
		{
			if (i == 2)
				continue;
	...
	else if ((strcmp(boad[a][b], boad[a + 1][b - 1]) == 0 && strcmp(boad[a][b], boad[a - 2][b + 2]) == 0) && strcmp(boad[a][b], "○") == 0) { // case 5
		for (int i = -1; i < 3; i++)
		{
			if (i == 1)
				continue;
	...
	else if ((strcmp(boad[a][b], boad[a - 3][b + 3]) == 0 && strcmp(boad[a][b], boad[a - 2][b + 2]) == 0) && strcmp(boad[a][b], "○") == 0) { // case 6
		for (int i = -3; i < 1; i++) {
			if (i == -1)
				continue;
			if (diagonalThreecheck1(boad, a - i, b + i) == 1)
...
int diagonalCheckCase22(char boad[MAX][MAX][MAX], int a, int b) {
	int result = 0;
	if (((strcmp(boad[a][b], boad[a + 1][b + 1]) == 0 && strcmp(boad[a][b], boad[a + 3][b + 3]) == 0) && strcmp(boad[a][b], "○") == 0)) {	// case 1
		for (int i = 0; i < 4; i++) {
			if (i == 2)
				continue;
	...
	else if ((strcmp(boad[a][b], boad[a - 1][b - 1]) == 0 && strcmp(boad[a][b], boad[a + 2][b + 2]) == 0) && strcmp(boad[a][b], "○") == 0) { // case 2
		for (int i = -1; i < 3; i++)
		{
			if (i == 1)
				continue;
	...
	else if ((strcmp(boad[a][b], boad[a - 2][b - 2]) == 0 && strcmp(boad[a][b], boad[a - 3][b - 3]) == 0) && strcmp(boad[a][b], "○") == 0) { // case 3
		for (int i = -3; i < 1; i++)
		{
			if (i == -1)
				continue;
	...
	else if ((strcmp(boad[a][b], boad[a + 2][b + 2]) == 0 && strcmp(boad[a][b], boad[a + 3][b + 3]) == 0) && strcmp(boad[a][b], "○") == 0) { // case 4
		for (int i = 0; i < 4; i++)
		{
			if (i == 1)
				continue;
	...
	else if ((strcmp(boad[a][b], boad[a - 3][b - 3]) == 0 && strcmp(boad[a][b], boad[a - 1][b - 1]) == 0) && strcmp(boad[a][b], "○") == 0) { // case 6
		for (int i = -3; i < 1; i++) {
			if (i == -2)
				continue;
			if (diagonalThreecheck2(boad, a + i, b + i) == 1)
...
/*
int whithThreeCheckCase2(char boad[MAX][MAX], int a, int b) {
...
int HeightThreeCheckCase2(char boad[MAX][MAX], int a, int b) {

}
int diagonal1_ThreeCheckCase2(char boad[MAX][MAX], int a, int b) {

}
int diagonal2_ThreeCheckCase2(char boad[MAX][MAX], int a, int b) {
