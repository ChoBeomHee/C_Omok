...
int whithThreeCheckCase2(char boad[MAX][MAX][MAX], int a, int b) {

}
int HeightThreeCheckCase2(char boad[MAX][MAX][MAX], int a, int b) {

}
int diagonal1_ThreeCheckCase2(char boad[MAX][MAX][MAX], int a, int b) {

}
int diagonal2_ThreeCheckCase2(char boad[MAX][MAX][MAX], int a, int b) {
